...
Edit the file file:org.css and update the file =inline.css.org= by running
...
The license file file:fonts/Lora/OFL.txt describes the terms under which the font
/Lora/ is distributed.

The license files file:LICENSE.MIT and file:LICENSE.996ICU applies to =org.css=
and the derivative file =inline.css.org=.

The license file file:LICENSE.MIT applies to the remaining sources in the root
